...
// Format driver name
export function formatDriverName(givenName: string, familyName: string, format: 'full' | 'short' | 'abbrev' = 'full'): string {
  switch (format) {
    case 'full':
...
export function formatRaceDate(dateString: string, timeString?: string): string {
